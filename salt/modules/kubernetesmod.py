...
def create_secret(
    ...
    **kwargs
    ...
    body = kubernetes.client.V1Secret(
        metadata=__dict_to_object_meta(name, namespace, {}), data=data, type=secrettype
    )
...
def create_configmap(
    name, namespace, data, source=None, sources=None, template=None, saltenv="base", **kwargs
):
    """
...
def create_endpoints(
    name, namespace, metadata, subsets, source, template, saltenv, **kwargs
):
    """
...
def replace_endpoints(
    name, metadata, subsets, source, template, old_endpoints, saltenv, namespace="default", **kwargs
):
    """
...
def __create_object_body_with_subsets(
    kind,
    obj_class,
    subsets_creator,
    name,
...
def __read_and_render_template_file(source, template, saltenv):
    """
